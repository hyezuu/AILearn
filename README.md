...
<details>
<summary>목차 펼치기/접기</summary>

| 섹션 | 설명 |
|------|------|
| [📌 프로젝트 소개](#-프로젝트-소개) | AILearn 서비스 개요 |
| [🚩 프로젝트 개요](#-프로젝트-개요) | 프로젝트 기간 및 배포 정보 |
| [🎯 주요 기능](#-주요-기능) | AILearn의 핵심 기능 설명 |
| [👥 팀 구성 및 역할](#-팀-구성-및-역할) | 팀원 소개 및 담당 업무 |
| [🛠 기술 스택](#-기술-스택) | 사용된 기술 및 도구 |
| [🌐 아키텍처](#-아키텍처) | 시스템 아키텍처 다이어그램 |
| [🔗 ERD](#-erd) | 데이터베이스 구조 다이어그램 |
| [📋 요구사항 정의서](#-요구사항-정의서) | 상세 기능 요구사항 |
| [🖥 화면 구성](#-화면-구성) | UI/UX 디자인 및 스크린샷 |
| [📜 API 명세서](#-api-명세서) | RESTful API 엔드포인트 목록 |
